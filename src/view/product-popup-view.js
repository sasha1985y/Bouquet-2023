  ...
  return (
    `<div class="popup-content">
      ...
      <div class="product-description__header">
        ...
        <button class="btn btn--outlined btn--full-width product-description__button deffer" type="button" data-focus="">отложить</button>
      </div>
      </div>`
  );
};
...
export default class ProductPopupView extends AbstractView {
  ...
  constructor({ product, onCheckButtonClick }) {
    super();
